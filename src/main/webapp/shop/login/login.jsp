...
<div class="wrapper" id="login_head" style="display:">
	<div class="log_head">
		<h1 class="log_logo left"><a href="javascript:;"><img src="<%=basePath%>shop/image/logo.png" width="80" height="80" align="middle" >
        <span>欢迎登录！！</span></a></h1>
	</div>
</div>
		...
		<div class="login_border" style="padding:8px;">
			<div class="login" style="display: block;">
				<div style="position:absolute; right:30px; top:14px;">
					<a href="<%=basePath%>shop/login/zhuce.jsp" target="_blank">账号注册
				...
				<div class="login-body">
					<div class="login-style" style="display: block;">
						<dl><dd><img src="../image/iconfont-yonghu.png"><input name="user" type="text" id="txtUser" placeholder="手机号"  /></dd></dl>
				<dl><img src="<%=basePath%>shop/image/iconfont-psw.png">
     <dd><input type="password" id="Userpwd" onKeyDown="enterHandler(event)" placeholder="请输入您的密码" name="pass" /></dd>
						</dl>
